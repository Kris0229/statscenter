...
from app.api.schedule_import import router as schedule_import_router
...
app.include_router(schedule_import_router, prefix="/api/v1")
app.include_router(media_router, prefix="/api/v1")
app.include_router(reports_router, prefix="/api/v1")

# Local-disk media (STORAGE_BACKEND=local only; harmless no-op otherwise —
# nothing ever gets written there so the mount just serves an empty dir).
